...
if (!function_exists('radian2degree')) {
...
if (!function_exists('degree2radian')) {
...
if (!function_exists('UTMCentralMeridian')) {
...
if (!function_exists('LatLonToUTMXY')) {
...
if (!function_exists('UTMXYToLatLon')){
...
if (!function_exists('MapXYToLatLon')) {
...
if (!function_exists('FootpointLatitude')) {
...
if(!function_exists('MapLatLonToXY')) {
...
if (!function_exists('ArcLengthOfMeridian')) {
